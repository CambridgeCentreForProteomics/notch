...
phospho_abundance_cols <- colnames(phospho_psm)[grepl('Abundance.', colnames(phospho_psm))]

phospho_e <- as.matrix(phospho_psm[,phospho_abundance_cols])
phospho_f <- phospho_psm[,setdiff(colnames(phospho_psm), phospho_abundance_cols)]
...
phospho_res_flt <- phospho_res %>% filter_TMT_PSMs(inter_thresh=20, sn_thresh=10)
plot_TMT_notch(phospho_res, facet_by_sample=TRUE)
plot_TMT_notch(phospho_res_flt, facet_by_sample=TRUE)
```

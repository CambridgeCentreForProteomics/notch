...
psm_res_flt_intensity <- readRDS('../results/psm_res_flt_intensity.rds')
expected <- readRDS('../results/expected.rds')
```

Create a list of PSM datasets
```{r}
psm_datasets <- list('unfiltered'=psm_res,
                     'filt Iso, Q'=psm_res_flt,
                     'filt Iso, Q, Notch'=psm_res_flt_intensity,
                     'filt Iso, Q, S:N'=psm_res_flt_sn)
```
